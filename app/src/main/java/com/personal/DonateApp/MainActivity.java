...
public class MainActivity extends AppCompatActivity implements RoomListener {
    ...
    private String channelID = "dgpKj6Xi7ukgP0nj";
    ...
    @Override
    public void onMessage(Room room, final Message message) {
        // TODO
        ...
        try {
            ...
            final Mensagem mensagem = new Mensagem(message.getData().asText(), data, belongsToCurrentUser);
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    messageAdapter.add(mensagem);
